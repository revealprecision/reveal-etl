...
def transform_reveal_location_data(server_version = 0):
    ...
    for data_line in data:
        sql = "INSERT INTO reveal.locations (id, created_at, uid, jurisdiction_id, code, type, name, status, geometry, geographic_level, effective_start_date, effective_end_date, version, server_version) VALUES ('" + str(data_line[0]) + "','" + str(data_line[1]) + "','" + str(data_line[2]) + "','" + str(data_line[3]) + "','" + str(data_line[4]) + "','" + str(data_line[5]) + "','" + str(data_line[6]).replace("'",r"''") + "','" + str(data_line[7]) + "','" + data_line[8] + "','" + str(data_line[9]) + "','" + data_line[10] + "','" + data_line[11] + "','" + str(data_line[12]) + "','" + str(data_line[13]) + "') ON CONFLICT (id) DO UPDATE SET name = '" + str(data_line[6]) + "', status = '" + str(data_line[7]) + "', geometry = '" + data_line[8] + "', geographic_level = '" + str(data_line[9]) + "', version = '" + str(data_line[12]) + "', server_version = '" + str(data_line[13]) + "';"
...
def transform_reveal_task_data():
    ...
    for data_line in data:
        sql = "INSERT INTO reveal.tasks (identifier, created_at, plan_identifier, group_identifier, status, business_status, priority, code, description, focus, task_for, execution_start_date, execution_end_date, owner, note, server_version) VALUES ('" + str(data_line[0]) + "','" + str(data_line[1]) + "','" + str(data_line[2]) + "','" + str(data_line[3]) + "','" + str(data_line[4]) + "','" + str(data_line[5]) + "','" + str(data_line[6]) + "','" + str(data_line[7]).replace("'",r"''") + "','" + str(data_line[8]).replace("'",r"''") + "','" + str(data_line[9]) + "','" + data_line[10] + "','" + data_line[11] + "','" + str(data_line[12]) + "','" + str(data_line[13]) + "','" + str(data_line[14]) + "','" + str(data_line[15]) + "') ON CONFLICT (identifier) DO UPDATE SET group_identifier = ' " + str(data_line[3]) + "', status = '" + str(data_line[4]) + "', business_status = '" + data_line[5] + "', priority = '" + str(data_line[6]) + "', code = '" + str(data_line[7]).replace("'",r"''") + "', description = '" + str(data_line[8]).replace("'",r"''") + "', focus = '" + str(data_line[9]) + "', task_for = '" + str(data_line[10]) + "', execution_start_date = '" + str(data_line[11]) + "', execution_end_date = '" + str(data_line[12]) + "', owner = '" + str(data_line[13]) + "';"
