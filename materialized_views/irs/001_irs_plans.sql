...
DROP MATERIALIZED VIEW IF EXISTS irs_plans CASCADE;

CREATE MATERIALIZED VIEW IF NOT EXISTS irs_plans
AS
SELECT
...
CREATE UNIQUE INDEX IF NOT EXISTS irs_plans_idx ON irs_plans (plan_id);